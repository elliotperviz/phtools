...
- [**avgpos**](https://github.com/acammarat/phtools/tree/main/avgpos) Calculate the average position and standard deviation of selected atoms along a specified crystallographic direction from a structure file - for example, to evaluate the displacements generated by specific phonon modes
